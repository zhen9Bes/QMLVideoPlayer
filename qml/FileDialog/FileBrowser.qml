                ...
                Rectangle {
                    ...
                    function launch() {
                        ...
                        if (folders.isFolder(index))
                            ...
                            //QUrl urlPath = fromLocalFile(path)
                    ...
                    Item {
                        ...
                        Image {
                            id: folderPicture
                            source: "qrc:/icons/FileDialog/folder.png"
                    ...
                    Text {
                        ...
                        color: (wrapper.ListView.isCurrentItem
                                && root.showFocusHighlight) ? palette.highlightedText : textColor
                ...
                Rectangle {
                    ...
                    Rectangle {
                        ...
                        Image {
                            ...
                            source: "qrc:/icons/FileDialog/up.png"
                        }
                        MouseArea {
                            id: upRegion
                            anchors.centerIn: parent
